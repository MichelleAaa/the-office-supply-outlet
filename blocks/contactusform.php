...
<div class="wp-block-group alignfull has-background" style="background:linear-gradient(245deg,rgb(198,2,2) 16%,rgb(204,2,2) 54%,rgb(155,81,224) 54%,rgb(52, 48, 49) 54%);padding-top:35px;padding-right:35px;padding-bottom:35px;padding-left:35px"><!-- wp:html -->
...
<div class="wp-block-columns" style="margin-top:10px;margin-bottom:10px"><!-- wp:column -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100 has-custom-font-size is-style-fill" style="font-size:15px"><input type="text" name="name" placeholder="Your Name" class="wp-block-button__link has-text-color has-background has-text-align-left wp-element-button" style="border-radius:2px;color:#666666c2;background-color:#f4f6f9"/></div>
<!-- /wp:button -->
...
<div class="wp-block-column"><!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"textAlign":"left","width":100,"style":{"color":{"background":"#f4f6f9","text":"#666666c2"},"border":{"radius":"2px"},"typography":{"fontSize":"15px"}},"className":"is-style-fill"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 has-custom-font-size is-style-fill" style="font-size:15px"><input type="text" name="email" placeholder="Your Email" class="wp-block-button__link has-text-color has-background has-text-align-left wp-element-button" style="border-radius:2px;color:#666666c2;background-color:#f4f6f9"/></div>
<!-- /wp:button -->

<!-- wp:button {"textAlign":"left","width":100,"style":{"color":{"background":"#f4f6f9","text":"#666666c2"},"border":{"radius":"2px"},"typography":{"fontSize":"15px"}},"className":"is-style-fill"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 has-custom-font-size is-style-fill" style="font-size:15px"><input type="text" name="subject" placeholder="Subject" class="wp-block-button__link has-text-color has-background has-text-align-left wp-element-button" style="border-radius:2px;color:#666666c2;background-color:#f4f6f9"/></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"textColor":"white","style":{"color":{"background":"rgb(198,2,2)"},"typography":{"fontSize":"18px","fontStyle":"normal","fontWeight":"600"},"border":{"radius":"4px"}}} -->
<div class="wp-block-button has-custom-font-size" style="font-size:18px;font-style:normal;font-weight:600"><button type="submit" class="wp-block-button__link has-white-color has-text-color has-background wp-element-button" style="border-radius:4px;background-color:rgb(198,2,2)">Send Message</button></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
</form>
<!-- /wp:group -->