  ...
  <div class="carousel-inner">
    ...
    for($count = 0; $count < count($heading_data); $count++){
        ...
        ?>
            ...
            <div class="wp-block-cover alignwide has-custom-content-position is-position-center-left" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;min-height:50px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim wp-block-cover__gradient-background has-background-gradient" style="background:linear-gradient(115deg,rgb(204,2,2) 0%,rgba(255,255,255,0) 6%,rgba(255,255,255,0) 93%,rgb(204,2,2) 93%)"></span><img class="wp-block-cover__image-background" alt="heading image" src="<?php echo esc_url( $heading_data[$count]["img-url"] ); ?>" data-object-fit="cover" /><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"constrained","contentSize":""},"align":"full","style":{"color":{"gradient":"linear-gradient(110deg,rgb(204,2,2) 0%,rgb(204,2,2) 58%,rgba(255,255,255,0) 58%)"},"spacing":{"blockGap":"0px","padding":{"top":"30px","right":"0px","bottom":"30px","left":"30px"},"margin":{"top":"0px","bottom":"0px"}}}} -->
            <div class="wp-block-group alignfull has-background" style="background:linear-gradient(110deg,rgb(204,2,2) 0%,rgb(204,2,2) 58%,rgba(255,255,255,0) 58%);margin-top:0px;margin-bottom:0px;padding-top:30px;padding-right:0px;padding-bottom:30px;padding-left:30px"><!-- wp:columns {"align":"wide","style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"},"blockGap":"0px","margin":{"top":"0px","bottom":"0px"}}}} -->
